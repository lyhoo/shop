...
public class ToGet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Myhelper myhelper = new Myhelper(ToGet.this);
        ...
        i1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ToGet.this,main_interface.class);
                intent.putExtra("flag",4);
                startActivity(intent);
            }
        });
        if (cursor.getCount()==0){
            t1.setText("您还没有待收货的商品！");
        }else {
            int num = 0;
            while (cursor.moveToNext()){
                ...
                if (difference>=120000&&difference<240000){
    ...
    class MyBaseAdapter extends BaseAdapter {
        ...
        public View getView(int position , View converView , ViewGroup parent){
            View view = View.inflate(ToGet.this,R.layout.list_item_history,null);
