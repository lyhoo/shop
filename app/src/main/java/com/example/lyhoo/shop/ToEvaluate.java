...
public class ToEvaluate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Myhelper myhelper = new Myhelper(ToEvaluate.this);
        ...
        i1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ToEvaluate.this,main_interface.class);
                intent.putExtra("flag",4);
                startActivity(intent);
            }
        });
        if (cursor.getCount()==0){
            t1.setText("您还没有待评价的商品！");
        }else {
            int num = 0;
    ...
    class MyBaseAdapter extends BaseAdapter {
        ...
        public View getView(int position , View converView , ViewGroup parent){
            View view = View.inflate(ToEvaluate.this,R.layout.list_item_history,null);
