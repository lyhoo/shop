...
public class shopcart_ extends AppCompatActivity implements View.OnClickListener, ShopcatAdapter.CheckInterface, ShopcatAdapter.ModifyCountInterface, ShopcatAdapter.GroupEditorListener{
...
//    PtrFrameLayout mPtrFrame;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shopcart_);
...
//                }
    ...
    private void initData() {
        ...
        for (int i = 0; i < 2; i++) {
            groups.add(new StoreInfo(i + "", "lyhoo的第" + (i + 1) + "号当铺"));
            ...
            for (int j = 0; j <= i; j++) {
                ...
                goods.add(new GoodsInfo(1, "商品", groups.get(i).getName() + "的第" + (j + 1) + "个商品", 255.00 + new Random().nextInt(1500), 1555 + new Random().nextInt(3000), "第一排", "出头天者", img[j], new Random().nextInt(100)));
            }
